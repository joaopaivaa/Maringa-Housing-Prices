...
def pedro_granado_scraper():
    ...
    for j in range(1, num_pages + 1):
        ...
        for property in properties:
            ...
            num_bedroom = num_bed_bath_garage[0].text.split('|')[1].strip() if len(num_bed_bath_garage) > 0 else None
            num_bathroom = num_bed_bath_garage[1].text.split('|')[1].strip() if len(num_bed_bath_garage) > 1 else None
...
def silvio_iwata_scraper():
    ...
    for j in range(1, num_pages + 1):
        ...
        for property in properties:
            ...
            category = small_text[0] if small_text else None
            type = None
            ref = None
